...
tags:
  ...
  - project/blog
  - status/published
ai_summary: "Guia técnico sobre fissuras em Light Steel Frame: por que acontecem, como prevenir e como reparar. Dados reais e comparativo com alvenaria."
status: published
projeto: blog
slug: fissuras-steel-frame
data_publicacao: 2025-03-10
title: "Fissuras no Steel Frame: Causas, Prevenção e Reparo"
seo_title: "Fissuras no Steel Frame: Causas, Prevenção e Reparo — Guia Técnico 2025"
...
palavras_chave:
  ...
  - trincas steel frame
  - placa cimentícia fissura
  - como evitar trincas steel frame
  - construção a seco
  - Light Steel Frame
category: Engenharia e Técnica
read_time: 12 min
author: Equipe Berkahn
url_final: "https://www.berkahn.com.br/atualidades/fissuras-steel-frame"
contextos_aplicados:
  - berkahn-brand
  - seo-aeo-strategy
  - article-pipeline
...
## O que a pesquisa acadêmica diz sobre fissuras em LSF
...
## Os tipos de fissura que ocorrem no Steel Frame e suas causas
...
## Fissuras em LSF comparadas com fissuras em alvenaria
...
## Como a execução correta previne fissuras

O protocolo de tratamento de juntas em placas cimentícias segue uma sequência de múltiplas camadas que não admite atalhos. A Brasilit, um dos principais fabricantes de placas cimentícias no Brasil, documenta um processo em dez etapas: fixação das placas com espaçamento de 3mm, aplicação de primer nas juntas, preenchimento com selante flexível, aplicação de base coat cimentício sobre toda a superfície, embutimento de fita de fibra de vidro de 5cm (resistente a álcalis, malha 8×8) no composto ainda úmido, segunda camada de composto, embutimento de fita de 10cm sobre a primeira, terceira camada com nivelamento, espera mínima de 24 horas para cura e acabamento final com composto e tinta 100% acrílica.
...
## Normas brasileiras que regulam o tema

Sete normas ABNT formam o arcabouço regulatório relevante. A NBR 15253 (2ª edição, 2014) governa perfis de aço galvanizado para painéis estruturais, especificando resistência ao escoamento mínima de 230 MPa, espessura de 0,80 a 3,00mm e galvanização mínima Z275 (275 g/m²). A NBR 15575 (Norma de Desempenho), na Parte 4, exige que sistemas de vedação vertical não apresentem fissuras, deslocamentos ou rupturas, tolerando fissuras superficiais apenas se não comprometerem a estanqueidade. A NBR 14715 especifica chapas de gesso acartonado. A NBR 15498 (edição 2021) classifica placas cimentícias em Tipo A (externa sem acabamento), B (externa com acabamento) e C (uso interno). A NBR 15758 cobre projeto e montagem de drywall, e a NBR 16970 (2022) aborda especificamente sistemas em LSF.

A lacuna identificada pela pesquisa da UFOP permanece: não existe norma ABNT unificada para tratamento de juntas em placas cimentícias no LSF. Enquanto essa padronização não chega, seguir rigorosamente o manual técnico do fabricante da placa utilizada continua sendo a referência mais segura.

## Como reparar fissuras existentes
...
**Steel Frame racha?**
Fissuras podem aparecer nas juntas entre placas e no acabamento, mas são cosméticas. A estrutura de aço galvanizado é articulada e absorve movimentação sem fissurar. O estudo da UNICAMP confirma que todas as patologias documentadas em LSF são de acabamento, não estruturais.

**Fissura em Steel Frame é normal?**
Pode ocorrer, especialmente no primeiro ciclo sazonal (primeiro verão e inverno após a construção), quando os materiais acomodam. Com execução correta do tratamento de juntas, seguindo todas as etapas do protocolo do fabricante, a incidência cai drasticamente. Fissura recorrente indica erro de execução ou projeto.

**Steel Frame racha mais que alvenaria?**
Os dados disponíveis sugerem o contrário. Auditorias do MCMV encontraram fissuras em 30,8% das unidades em alvenaria. Não existe levantamento equivalente para LSF no Brasil, mas a literatura internacional (SCI P262) registra desempenho superior do steel framing em estabilidade dimensional. Todas as fissuras em LSF são cosméticas, enquanto em alvenaria podem ser estruturais.

**Quanto custa reparar uma fissura em Steel Frame?**
Entre R$ 20 e R$ 80 por metro linear para fissuras cosméticas, usando massa, fita e tinta. Reparos em alvenaria com comprometimento estrutural podem custar de R$ 5.000 a R$ 50.000 ou mais, dependendo da causa.

**Qual a diferença entre fissura, trinca e rachadura?**
A NBR 15575 não define esses termos com precisão numérica, mas a convenção técnica classifica fissuras como aberturas de até 0,5mm, trincas entre 0,5mm e 1,5mm, e rachaduras acima de 1,5mm. Em LSF, a grande maioria das ocorrências são fissuras (abaixo de 0,5mm).

**Existe garantia contra fissuras em Steel Frame?**
Depende da construtora e do contrato. A NBR 15575 estabelece prazos de garantia mínimos para sistemas de vedação. Na Austrália, a garantia do fabricante da placa pode ser condicionada ao uso correto de técnicas como back-blocking. No Brasil, o cumprimento documentado do protocolo de tratamento de juntas do fabricante é a melhor proteção contratual.

## Transparência técnica como critério de escolha
...
1. **Tabela comparativa: Fissuras em LSF vs. Alvenaria**
   - O que mostra: severidade, localização típica, risco estrutural, custo de reparo, complexidade e tendência de progressão nos dois sistemas
   - Onde inserir: após a seção "Fissuras em LSF comparadas com fissuras em alvenaria"
   - Relevância: é a informação que o leitor em fase de decisão mais precisa visualizar de forma rápida. Nenhum concorrente oferece essa comparação tabulada com dados

2. **Diagrama esquemático: Anatomia de uma junta tratada corretamente**
   - O que mostra: corte transversal de uma junta entre placas cimentícias com todas as camadas (placa, gap de 3mm, primer, selante, base coat, tela 5cm, segunda camada, tela 10cm, terceira camada, acabamento)
   - Onde inserir: dentro da seção "Como a execução correta previne fissuras"
   - Relevância: traduz o protocolo de 10 etapas em imagem. Permite compreensão imediata de por que cada camada existe e por que pular etapas causa problemas

3. **Box de destaque: Coeficientes de dilatação térmica dos materiais**
   - O que mostra: tabela simples com CTE do aço (12), gesso (16,7), concreto (10-12), tijolo (4-8) e placa cimentícia (8-12), em unidades × 10⁻⁶/°C
   - Onde inserir: dentro da seção "Os tipos de fissura que ocorrem no Steel Frame e suas causas", após o parágrafo sobre dilatação diferencial
   - Relevância: fundamenta tecnicamente por que juntas precisam de tratamento flexível. Dado técnico que engenheiros e arquitetos valorizam

4. **Infográfico de custo: Reparo em LSF vs. Reparo estrutural em alvenaria**
   - O que mostra: comparação visual de faixas de custo (R$ 20-80/m para LSF cosmético vs. R$ 5.000-50.000+ para alvenaria estrutural), incluindo tempo estimado e necessidade ou não de laudo estrutural
   - Onde inserir: após a seção comparativa, complementando a tabela
   - Relevância: custo é o fator decisivo para o público residencial. Visualizar a escala de diferença (ordens de grandeza) é mais impactante que ler números em texto

**Internal links sugeridos:**
- "Light Steel Frame" (primeira menção) → página /lsf do site Berkahn
- "construção industrializada" → artigo sobre o que é construção industrializada
- "sistemas construtivos" → artigo comparativo LSF vs. alvenaria vs. wood frame
- "tratamento de juntas" → artigo técnico sobre tratamento de juntas (a criar)
- "solicite um orçamento" → página /orcamento do site Berkahn

**External links incluídos:**
- UNICAMP (estudo Testolino/Moreno Jr): https://prp.unicamp.br/pibic/congressos/xixcongresso/paineis/094300.pdf
- UFOP (dissertação Hofmann sobre juntas invisíveis): https://www.propec.ufop.br/teses-e-dissertacoes/231/tratamentos-de-juntas-invisiveis-em-placas-cimenticias-no-fechamento-de-sistemas-light-steel-framing
- SCI P262 (durabilidade do LSF): https://www.steelconstruction.info/images/6/6d/SCI_P262.pdf
- Placo do Brasil (fissuras em drywall): https://www.placo.com.br/blog/trincas-e-fissuras-no-drywall-como-evitar-e-resolver
- GA-235 (propriedades do gesso): https://www.americangypsum.com/sites/default/files/2022-01/ga-235_gypsum_board_typical_mechanical_and_physical_properties.pdf
- Brasilit (guia placas cimentícias): https://www.brasilit.com.br/blog/336

**Imagens necessárias:**

1. Foto de fissura em junta de placa cimentícia (close-up, alta resolução)
   - Alt text: "Fissura linear em junta entre placas cimentícias em fachada de Steel Frame"
   - Posição: após o primeiro parágrafo da seção sobre tipos de fissura

2. Foto de parede em alvenaria com trinca escalonada (para comparativo visual)
   - Alt text: "Trinca escalonada em parede de alvenaria convencional por recalque de fundação"
   - Posição: seção comparativa LSF vs. alvenaria

3. Foto ou render do processo de tratamento de juntas mostrando tela de fibra de vidro sendo embutida
   - Alt text: "Tela de fibra de vidro sendo embutida em base coat durante tratamento de junta cimentícia"
   - Posição: seção sobre execução correta

4. Foto de reparo finalizado em parede de drywall (resultado limpo, sem vestígio de fissura)
   - Alt text: "Parede de gesso acartonado após reparo de fissura com massa e fita"
   - Posição: seção sobre reparo de fissuras existentes
...
- Contagem de palavras: ~2.380 palavras (dentro do limite de 2.500)
- Público priorizado: residencial alto padrão como público primário, engenheiros/arquitetos como público secundário. Razão: fissuras são a objeção número um de quem considera construir em LSF para moradia. O público residencial classe A/B (ticket R$ 500k-2M) precisa de segurança técnica antes de investir. A profundidade normativa e os dados de coeficiente térmico atendem simultaneamente o público técnico, que influencia a decisão. O segmento comercial/industrial não foi priorizado porque fissuras cosméticas são menos relevantes como fator de decisão nesses contextos.
- SEO: o artigo preenche um vácuo real no conteúdo em português. A pesquisa identificou zero artigos dedicados exclusivamente a fissuras em Steel Frame com esta profundidade. Os concorrentes ou minimizam o problema (posts promocionais) ou são academicamente inacessíveis (teses). O ângulo de "transparência técnica" é o diferencial editorial.
- Nota técnica: os dados de custo de reparo (R$ 20-80/m para LSF, R$ 5.000-50.000+ para alvenaria estrutural) são estimativas baseadas em valores de mercado citados na pesquisa. Podem ser ajustados conforme experiência da equipe Berkahn.
- A keyword "fissuras steel frame" aparece naturalmente no título H1, na meta description, na abertura e ao longo do texto, sem forcing. Keywords secundárias distribuídas organicamente.
