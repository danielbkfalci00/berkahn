...
tags:
  - project/site
  - status/active
ai_summary: "Hub do projeto Site — Next.js 15 + Supabase + Vercel em produção (berkahn.com.br + admin.berkahn.com.br, mesmo build). Em 2026-08-05/06 - redesign completo da home na branch feat/home-scrollytelling (PR 43), com direção 'luxo de engenharia' mono ([[home-redesign-direcao]]); e quadro de pautas em /admin/conteudo (migrations 010/011, 66 pautas semeadas), com fim da dupla escrita dos comandos. Seis rotas /api/admin sem autenticação também foram fechadas; o PostgREST não devolve erro quando a RLS filtra uma linha, então toda mutação precisa conferir a linha afetada (ver [[quadro-conteudo]]). Em 2026-07-30 - soft 404 de /atualidades corrigido e ISR restaurado. Code paths em app/, lib/, components/."
status: active
projeto: site
