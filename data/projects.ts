...
O projeto combina conforto térmico, eficiência energética e design atemporal, ideal para quem busca qualidade de vida em meio à natureza.`,
    ...
    gallery: [
      ...
      { src: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1200&q=80', alt: 'Sala de estar integrada com varanda', type: 'interior' },
      { src: 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?auto=format&fit=crop&w=1200&q=80', alt: 'Cozinha gourmet com ilha central', type: 'interior' },
      { src: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&w=1200&q=80', alt: 'Suite master com vista para jardim', type: 'interior' },
      { src: 'https://images.unsplash.com/photo-1600573472592-401b489a3cdc?auto=format&fit=crop&w=1200&q=80', alt: 'Banheiro em marmore branco', type: 'interior' },
      { src: 'https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?auto=format&fit=crop&w=1200&q=80', alt: 'Deck em madeira com piscina', type: 'exterior' },
    ],
    floorPlans: [],
    models: [],
    specifications: [],
...
A estrutura em steel frame permite flexibilidade de layout e instalação rápida.`,
    ...
    gallery: [
      ...
      { src: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=1200&q=80', alt: 'Espaco aberto com pe-direito duplo', type: 'interior' },
      { src: 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&w=1200&q=80', alt: 'Cozinha integrada estilo industrial', type: 'interior' },
      { src: 'https://images.unsplash.com/photo-1536376072261-38c75010e6c9?auto=format&fit=crop&w=1200&q=80', alt: 'Mezanino com home office', type: 'interior' },
      { src: 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=1200&q=80', alt: 'Banheiro minimalista', type: 'interior' },
    ],
    floorPlans: [],
    models: [],
    specifications: [],
...
Perfeito para refúgio de montanha ou casa de campo, oferecendo aconchego em todas as estações.`,
    ...
    gallery: [
      { src: '/images/chale-rustico.png', alt: 'Chale Rustico', type: 'exterior' },
      { src: 'https://images.unsplash.com/photo-1542718610-a1d656d1884c?auto=format&fit=crop&w=1200&q=80', alt: 'Interior aconchegante com lareira', type: 'interior' },
      { src: 'https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=1200&q=80', alt: 'Quarto com vista para montanha', type: 'interior' },
      { src: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&w=1200&q=80', alt: 'Deck com vista panoramica', type: 'exterior' },
      { src: 'https://images.unsplash.com/photo-1609766418204-94aae0ecfdfc?auto=format&fit=crop&w=1200&q=80', alt: 'Varanda com rede de descanso', type: 'exterior' },
    ],
    floorPlans: [],
    models: [],
    specifications: [],
