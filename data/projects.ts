...
A estrutura em steel frame permite flexibilidade de layout e instalação rápida.`,
    ...
    gallery: [
      ...
      { src: '/images/Services/Projetos prontos/loft/loft-urbano_4.webp', alt: 'Loft Urbano - Detalhe 4', type: 'interior' },
      { src: '/images/Services/Projetos prontos/loft/loft-urbano_5.webp', alt: 'Loft Urbano - Detalhe 5', type: 'interior' },
      { src: '/images/Services/Projetos prontos/loft/loft-urbano_6.webp', alt: 'Loft Urbano - Detalhe 6', type: 'interior' },
    ],
    floorPlans: [],
    models: [],
    specifications: [],
  ...
  // Chalé Rústico
  {
    ...
    category: 'residencial',
    subtype: 'chale',
    tagline: 'Modernidade e aconchego em harmonia com a natureza',
...
Projetado para acomodar confortavelmente uma família de 3 a 4 pessoas, oferece o equilíbrio perfeito entre rusticidade e eficiência construtiva moderna.`,
    ...
    highlights: [
      ...
      'Pé direito duplo',
      'Amplo mezanino',
      'Janelas grandes para iluminação natural',
      'Lavanderia integrada',
      'Ideal para climas frios e regiões serranas',
    ],
