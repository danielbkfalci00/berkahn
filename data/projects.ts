...
export const PROJECTS: Project[] = [
  ...
  // Casa de Campo
  {
    ...
    subtype: 'casa',
    tagline: 'Refúgio rural com conforto moderno',
    description: `Casa de campo em Light Steel Frame projetada para proporcionar o equilíbrio perfeito entre vida rural e conforto contemporâneo. Arquitetura que valoriza a integração com a natureza através de amplas aberturas e varandas generosas.

O sistema construtivo Steel Frame garante execução rápida, excelente isolamento térmico e baixa manutenção, ideal para propriedades rurais e de lazer.`,
    heroImage: '/images/Services/projetos-prontos/Casa-de-campo/casa-de-campo-hero.webp',
    cardImage: '/images/Services/projetos-prontos/Casa-de-campo/casa-de-campo-hero.webp',
    area: {
      builtArea: 120.00,
      minLotWidth: 15.0,
      minLotLength: 20.0,
    ...
    gallery: [
      { src: '/images/Services/projetos-prontos/Casa-de-campo/casa-de-campo-hero.webp', alt: 'Casa de Campo - Fachada principal', type: 'exterior' },
      { src: '/images/Services/projetos-prontos/Casa-de-campo/casa-de-campo-02.webp', alt: 'Casa de Campo - Vista alternativa', type: 'exterior' },
    ],
    floorPlans: [],
    models: [],
    specifications: [],
  ...
  // Chalé
  {
    ...
    category: 'residencial',
    subtype: 'chale',
    tagline: 'Design A-frame contemporâneo',
    description: `Chalé estilo nórdico A-frame em Light Steel Frame, perfeito para regiões serranas e climas frios. O design icônico combina eficiência estrutural com estética marcante, criando um refúgio acolhedor integrado à paisagem.

Interior otimizado com pé-direito alto, ambientes integrados e acabamentos em madeira que proporcionam sensação de aconchego e conexão com a natureza.`,
    heroImage: '/images/Services/projetos-prontos/Chalé/chale-hero.webp',
    cardImage: '/images/Services/projetos-prontos/Chalé/chale-hero.webp',
    area: {
      builtArea: 65.00,
      minLotWidth: 10.0,
      minLotLength: 15.0,
    ...
    gallery: [
      { src: '/images/Services/projetos-prontos/Chalé/chale-hero.webp', alt: 'Chalé A-frame - Fachada externa', type: 'exterior' },
      { src: '/images/Services/projetos-prontos/Chalé/chale_interior_1.webp', alt: 'Chalé - Interior sala', type: 'interior' },
      { src: '/images/Services/projetos-prontos/Chalé/chale_interior_2.webp', alt: 'Chalé - Área de estar', type: 'interior' },
      { src: '/images/Services/projetos-prontos/Chalé/chale_interior_3.webp', alt: 'Chalé - Quarto', type: 'interior' },
      { src: '/images/Services/projetos-prontos/Chalé/chale_interior_4.webp', alt: 'Chalé - Detalhes internos', type: 'interior' },
    ],
    floorPlans: [],
    models: [],
    specifications: [],
    highlights: [
      'Design A-frame icônico',
  ...
  // Loft
  {
    ...
    category: 'residencial',
    subtype: 'loft',
    tagline: 'Espaço compacto e funcional',
    description: `Loft moderno em Steel Frame que maximiza cada metro quadrado com design inteligente e funcional. Ambiente integrado com conceito open space, ideal para solteiros, casais ou como espaço de hospedagem em propriedades rurais.

Construção rápida e eficiente, com acabamentos contemporâneos e flexibilidade de layout para diferentes necessidades.`,
    heroImage: '/images/Services/projetos-prontos/Loft/loft-hero.webp',
    cardImage: '/images/Services/projetos-prontos/Loft/loft-hero.webp',
    area: {
      builtArea: 35.00,
      minLotWidth: 6.0,
      minLotLength: 8.0,
    ...
    gallery: [
      { src: '/images/Services/projetos-prontos/Loft/loft-hero.webp', alt: 'Loft - Fachada principal', type: 'exterior' },
      { src: '/images/Services/projetos-prontos/Loft/loft-01.webp', alt: 'Loft - Vista interna 1', type: 'interior' },
      { src: '/images/Services/projetos-prontos/Loft/loft-02.webp', alt: 'Loft - Vista interna 2', type: 'interior' },
      { src: '/images/Services/projetos-prontos/Loft/loft-03.webp', alt: 'Loft - Vista interna 3', type: 'interior' },
      { src: '/images/Services/projetos-prontos/Loft/loft-04.webp', alt: 'Loft - Vista interna 4', type: 'interior' },
      { src: '/images/Services/projetos-prontos/Loft/loft-05.webp', alt: 'Loft - Vista interna 5', type: 'interior' },
      { src: '/images/Services/projetos-prontos/Loft/loft-06.webp', alt: 'Loft - Vista interna 6', type: 'interior' },
    ],
    floorPlans: [],
    models: [],
    specifications: [],
