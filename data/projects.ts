...
O projeto combina conforto térmico, eficiência energética e design atemporal, ideal para quem busca qualidade de vida em meio à natureza.`,
  ...
  // Vila Serrana Boutique - Hotelaria
  {
    id: 'com-hotel-01',
    slug: 'vila-serrana-boutique',
    name: 'Vila Serrana Boutique',
    category: 'comercial',
    subtype: 'hotel',
    tagline: 'Hotelaria boutique com mini chalés em steel frame',
    description: `Empreendimento hoteleiro boutique em Canela, na serra gaúcha, projetado para proporcionar experiências únicas em meio à natureza. Cada mini chalé foi cuidadosamente desenvolvido em steel frame, combinando eficiência construtiva com design contemporâneo e acabamentos premium.

A arquitetura valoriza a integração com o ambiente natural através de amplas varandas, revestimentos em madeira e grandes esquadrias que emolduram a paisagem serrana. O pé-direito duplo e as vigas aparentes criam sensação de amplitude e aconchego.

O projeto demonstra a versatilidade do steel frame em empreendimentos comerciais de alto padrão, com acabamento hoteleiro que rivaliza com construções convencionais, mas com prazo de execução reduzido em 60% e precisão milimétrica.`,
    heroImage: '/images/Services/Projetos prontos/vila-serrana/vila-serrana-exterior-completo.webp',
    cardImage: '/images/Services/Projetos prontos/vila-serrana/vila-serrana-fachada-detalhe.webp',
    area: {
      builtArea: 55.00,
      minLotWidth: 12.0,
      minLotLength: 15.0,
    ...
    gallery: [
      { src: '/images/Services/Projetos prontos/vila-serrana/vila-serrana-exterior-completo.webp', alt: 'Fachada completa do chalé boutique Vila Serrana', type: 'exterior' },
      { src: '/images/Services/Projetos prontos/vila-serrana/vila-serrana-fachada-detalhe.webp', alt: 'Detalhe da fachada com varanda e revestimento em madeira', type: 'exterior' },
      { src: '/images/Services/Projetos prontos/vila-serrana/vila-serrana-interior-suite.webp', alt: 'Suíte premium com acabamento em madeira e vigas aparentes', type: 'interior' },
      { src: '/images/Services/Projetos prontos/vila-serrana/vila-serrana-construcao.webp', alt: 'Processo construtivo em steel frame da Vila Serrana Boutique', type: 'detail' },
    ],
    floorPlans: [],
    models: [],
    specifications: [
      { id: 'fundacao-radier', category: 'fundacao', name: 'Fundação em Radier', description: 'Sistema de fundação rasa adequado para distribuição uniforme de cargas.' },
      { id: 'estrutura-steel-frame', category: 'estrutura', name: 'Steel Frame 100%', description: 'Perfis galvanizados de alta resistência com montagem industrializada.' },
      { id: 'vedacao-osb-drywall', category: 'vedacao', name: 'OSB + Drywall', description: 'Vedação multicamada com isolamento térmico e acústico.' },
      { id: 'revestimento-wood-siding', category: 'revestimento', name: 'Wood Siding Premium', description: 'Revestimento externo em madeira tratada com acabamento natural.' },
      { id: 'cobertura-metalica', category: 'cobertura', name: 'Telha Metálica Termoacústica', description: 'Cobertura em telha metálica com isolamento térmico integrado.' },
      { id: 'esquadrias-pvc', category: 'esquadrias', name: 'Esquadrias em PVC', description: 'Janelas e portas em PVC com vidros duplos para isolamento.' },
    ],
    highlights: [
      'Acabamento hoteleiro premium',
      'Revestimento em madeira natural',
      'Vigas aparentes decorativas',
      'Pé-direito duplo',
    ...
    constructionTime: '60 dias por unidade',
    warranty: '5 anos',
    location: 'Canela, RS',
    year: 2023,
  },
  ...
  // Casa Laranjeiras
  {
    id: 'res-casa-laranjeiras-01',
    slug: 'casa-laranjeiras-contemporanea',
    name: 'Casa Laranjeiras',
    category: 'residencial',
    subtype: 'casa',
    tagline: 'Arquitetura contemporânea em harmonia com a natureza',
    description: `Residência contemporânea de alto padrão que redefine a integração entre arquitetura e paisagem. Com 399m² distribuídos em dois pavimentos, a casa apresenta volumetria minimalista em tons brancos com detalhes em madeira natural e telhado colonial em cerâmica.

O projeto destaca-se pela preservação de uma árvore existente que atravessa a estrutura principal, criando um elemento escultural único. Ampla área de lazer com piscina de 27m², jardins tropicais e integração total entre ambientes internos e externos através de grandes aberturas e varandas.`,
    heroImage: '/images/Apresentação/Casa Laranjeiras/casa-laranjeiras-entrada-principal.webp',
    cardImage: '/images/Apresentação/Casa Laranjeiras/casa-laranjeiras-entrada-principal.webp',
    area: {
      builtArea: 399.00,
      minLotWidth: 20.0,
      minLotLength: 50.0,
    ...
    gallery: [
      { src: '/images/Apresentação/Casa Laranjeiras/casa-laranjeiras-entrada-principal.webp', alt: 'Casa Laranjeiras - Entrada Principal', type: 'exterior' },
      { src: '/images/Apresentação/Casa Laranjeiras/casa-laranjeiras-piscina.webp', alt: 'Casa Laranjeiras - Área de Lazer com Piscina', type: 'exterior' },
      { src: '/images/Apresentação/Casa Laranjeiras/casa-laranjeiras-living.webp', alt: 'Casa Laranjeiras - Sala de Estar Integrada', type: 'interior' },
      { src: '/images/Apresentação/Casa Laranjeiras/casa-laranjeiras-jantar.webp', alt: 'Casa Laranjeiras - Sala de Jantar', type: 'interior' },
      { src: '/images/Apresentação/Casa Laranjeiras/casa-laranjeiras-lateral-piscina.webp', alt: 'Casa Laranjeiras - Vista Lateral', type: 'exterior' },
      { src: '/images/Apresentação/Casa Laranjeiras/casa-laranjeiras-pergola.webp', alt: 'Casa Laranjeiras - Pergola Externa', type: 'exterior' },
      { src: '/images/Apresentação/Casa Laranjeiras/casa-laranjeiras-fachada-lateral.webp', alt: 'Casa Laranjeiras - Fachada Lateral', type: 'exterior' },
      { src: '/images/Apresentação/Casa Laranjeiras/casa-laranjeiras-fachada-frontal.webp', alt: 'Casa Laranjeiras - Fachada Frontal', type: 'exterior' },
    ],
    floorPlans: [],
    models: [],
    specifications: [
      {
        id: 'fundacao-radier-laranjeiras',
        category: 'Fundação',
        name: 'Radier - Laje de concreto armado',
      },
      {
        id: 'estrutura-lsf-laranjeiras',
        category: 'Estrutura',
        name: 'Light Steel Frame (LSF) - Perfis de aço galvanizado',
      },
      {
        id: 'vedacao-premium-laranjeiras',
        category: 'Vedação',
        name: 'Placa cimentícia externa + Drywall interno + Laje seca',
      },
      {
        id: 'cobertura-colonial-laranjeiras',
        category: 'Cobertura',
        name: 'Telhado colonial em cerâmica',
      },
    ],
    highlights: [
      'Árvore integrada à estrutura principal',
      'Arquitetura contemporânea minimalista',
      'Piscina de 27m² com área de lazer completa',
      'Integração indoor-outdoor',
      'Acabamentos premium em madeira natural',
      'Telhado colonial mediterrâneo',
      'Jardins tropicais integrados',
      'Dois pavimentos com distribuição inteligente',
    ],
    constructionTime: '90-120 dias',
    warranty: '5 anos',
