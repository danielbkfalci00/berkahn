...
Leia o calendário estruturado em `Berkahn-Vault/80-bases/calendario.base` (Obsidian Base — substitui o antigo `Docs/blog/calendario.md` que não existia).
...
Mostre o estado atual do pipeline:
