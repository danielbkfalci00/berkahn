    ...
    <footer className="bg-black text-white py-16">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {/* Brand */}
          <div>
            <div className="text-2xl font-heading mb-4">BERKAHN</div>
            <p className="text-white-70 leading-relaxed">
              Erguendo o amanhã. Especialistas em construção Light Steel Frame,
              democratizando a construção de qualidade no Brasil.
            </p>
          </div>
