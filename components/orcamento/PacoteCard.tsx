...
export function PacoteCard({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "group relative flex flex-col h-full overflow-hidden rounded-xl transition-all duration-500 motion-reduce:!transform-none motion-reduce:!opacity-100 motion-reduce:!transition-none",
        isDestaque
    ...
    >
      ...
      <div className={cn("flex-1 flex flex-col p-6 lg:p-8", isDestaque && !pacote.imagemRepresentativa && "pt-14")}>
        {/* Header */}
        <div className="mb-6">
          <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-black/60 mb-1">
