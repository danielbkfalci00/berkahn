...
export function WhatsAppButton() {
  ...
  return (
    <TrackedWhatsAppLink
      href={WHATSAPP_URL}
      ctaLocation="whatsapp_flutuante"
      target="_blank"
      ...
      className={cn(
        ...
        "bg-black text-white",
        "shadow-luxury-sm",
        "hover:shadow-luxury-md hover:scale-105",
        "active:scale-95",
        "transition-[transform,box-shadow] duration-300 ease-out",
        "cursor-pointer animate-in fade-in-0 zoom-in-95 duration-300 motion-reduce:animate-none"
      )}
    >
      <svg
        viewBox="0 0 24 24"
