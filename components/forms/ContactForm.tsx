...
interface ContactFormProps {
  ...
  /**
   * Cabeçalho do formulário. O ContactFormDialog passa DialogTitle e
   * DialogDescription (o Radix exige DialogTitle para acessibilidade);
      ...
      {status === "success" ? (
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            {/* Telefone */}
            <div className="space-y-1.5">
              <Label htmlFor="phone" className="text-xs text-black-70 font-medium">
                Telefone (WhatsApp)
              </Label>
              <Input
                id="phone"
                ...
                onChange={(e) =>
                  setFormData({ ...formData, phone: formatarTelefone(e.target.value) })
                }
            ...
            <div className="space-y-1.5">
              ...
              >
                ...
                <SelectContent
                  portal={false}
                  className="bg-white border border-black-10 shadow-luxury-md"
                >
                  <SelectItem value="residencial" className="focus:bg-black-5 focus:text-black">
                    Residencial
                  </SelectItem>
                  <SelectItem value="comercial" className="focus:bg-black-5 focus:text-black">
            ...
            {/* Mensagem */}
            <div className="space-y-1.5">
              <Label htmlFor="message" className="text-xs text-black-70 font-medium">
                Mensagem
              </Label>
              <Textarea
                id="message"
