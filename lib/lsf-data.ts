...
export const LSF_FAQ: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "O sistema é regulamentado pela ABNT NBR 16970, aprovada em maio de 2022, dedicada exclusivamente ao Light Steel Frame. A norma está dividida em três partes: requisitos de desempenho, projeto estrutural e interfaces do sistema. Cobre edificações residenciais e não residenciais de até 2 pavimentos (expansível para 4-5 com a Diretriz SINAT nº 003). Normas complementares incluem a NBR 15253 (perfis de aço), NBR 14762 (dimensionamento estrutural) e NBR 15575 (desempenho de edificações). Com esse arcabouço normativo, o Steel Frame deixou de ser considerado \"alternativo\" e passou a ser um sistema construtivo convencional e plenamente regulamentado no Brasil.",
  },
  {
